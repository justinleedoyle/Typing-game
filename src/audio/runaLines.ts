...
const FINALE_LINES: readonly RunaLine[] = [
  ...
  // §5.5.11 counter-loadout — the Lord channels a facet of each minion Wren
  // overcame. A relic counters it; otherwise Wren must turn it aside in time.
  {
    id: "finale_facets_intro",
    scene: "finale",
    trigger: "GreatBattleScene.startFacetPhase() — the Lord channels the overcome (wired)",
    text: "He gathers the ones you put down. Their teeth, their tolls, their cold — all his to wear now.",
    tone: "urgent",
    isNew: true,
  },
  {
    id: "finale_facet_cold_telegraph",
    scene: "finale",
    trigger: "GreatBattleScene.runFacetSequence() — Cold facet telegraph (wired)",
    text: "The mountain's cold pours off him.",
    tone: "urgent",
    isNew: true,
  },
  {
    id: "finale_facet_cold_countered",
    scene: "finale",
    trigger: "GreatBattleScene.runFacetSequence() — Cold neutralized by the Pelt (wired)",
    text: "The Pelt of the Old One drinks the cold. It breaks on you and fails.",
    tone: "wonder",
    isNew: true,
  },
  {
    id: "finale_facet_toll_telegraph",
    scene: "finale",
    trigger: "GreatBattleScene.runFacetSequence() — Toll facet telegraph (wired)",
    text: "A drowned bell tolls inside his chest.",
    tone: "urgent",
    isNew: true,
  },
  {
    id: "finale_facet_toll_countered",
    scene: "finale",
    trigger: "GreatBattleScene.runFacetSequence() — Toll neutralized (wired)",
    text: "You answer the bell with its own iron. The peal dies.",
    tone: "wonder",
    isNew: true,
  },
  {
    id: "finale_facet_armor_telegraph",
    scene: "finale",
    trigger: "GreatBattleScene.runFacetSequence() — Armor facet telegraph (wired)",
    text: "Brass plates close over him, golem-hard.",
    tone: "urgent",
    isNew: true,
  },
  {
    id: "finale_facet_armor_countered",
    scene: "finale",
    trigger: "GreatBattleScene.runFacetSequence() — Armor neutralized (wired)",
    text: "The forge's own tool finds the seam. The armor falls open.",
    tone: "wonder",
    isNew: true,
  },
  {
    id: "finale_facet_light_telegraph",
    scene: "finale",
    trigger: "GreatBattleScene.runFacetSequence() — Light facet telegraph (wired)",
    text: "He flares — a blinding lantern-glare.",
    tone: "urgent",
    isNew: true,
  },
  {
    id: "finale_facet_light_countered",
    scene: "finale",
    trigger: "GreatBattleScene.runFacetSequence() — Light neutralized (wired)",
    text: "Your own light meets his, gentle and unafraid. You see clearly.",
    tone: "wonder",
    isNew: true,
  },
  {
    id: "finale_facet_grief_telegraph",
    scene: "finale",
    trigger: "GreatBattleScene.runFacetSequence() — Grief facet telegraph (wired)",
    text: "The wood's old grief rises off him in a whisper.",
    tone: "urgent",
    isNew: true,
  },
  {
    id: "finale_facet_grief_countered",
    scene: "finale",
    trigger: "GreatBattleScene.runFacetSequence() — Grief neutralized (wired)",
    text: "You already know this grief by name. It cannot move you.",
    tone: "wonder",
    isNew: true,
  },
  {
    id: "finale_facet_held",
    scene: "finale",
    trigger: "GreatBattleScene.runFacetChallenge() — Wren survives an uncountered facet (wired)",
    text: "You turn it aside. It costs you, but you hold.",
    tone: "urgent",
    isNew: true,
  },
  {
    id: "finale_facet_lands",
    scene: "finale",
    trigger: "GreatBattleScene.runFacetChallenge() — uncountered facet lands, a candle lost (wired)",
    text: "It lands. A candle gutters and goes dark.",
    tone: "urgent",
    isNew: true,
  },
  {
